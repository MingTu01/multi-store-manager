    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-violet-50 p-4">
      <GlassCard className="w-full max-w-sm p-8">
        <div className="mb-8 text-center">
          ...
          <h1 className="inline-block rounded-full bg-gradient-to-r from-indigo-50 via-purple-50 to-pink-50 px-4 py-1.5 text-xl font-bold bg-clip-text text-transparent">Multi Shop Link</h1>
